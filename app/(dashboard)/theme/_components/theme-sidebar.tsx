...
export function ThemeSidebar() {
  ...
  React.useEffect(() => {
    const stored = localStorage.getItem("theme-sidebar-expanded")
    if (stored !== null) {
  ...
  const toggleExpanded = () => {
    ...
    localStorage.setItem("theme-sidebar-expanded", String(newExpanded))
  }
        ...
        >
          {isExpanded ? (
            ...
            <Tooltip>
              ...
              <TooltipContent side="right">Theme Builder</TooltipContent>
            </Tooltip>
          )}
        </div>
