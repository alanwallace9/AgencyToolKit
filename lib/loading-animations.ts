...
.at-pulse-dot{width:32px;height:32px;background:var(--loading-color,#3b82f6);border-radius:50%;animation:at-pulse 1.2s ease-in-out infinite}
@keyframes at-pulse{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.5);opacity:0.5}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-ring{width:64px;height:64px;border:5px solid rgba(0,0,0,0.1);border-top-color:var(--loading-color,#3b82f6);border-radius:50%;animation:at-spin 1.5s linear infinite}
@keyframes at-spin{to{transform:rotate(360deg)}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-bounce{display:flex;gap:10px}
.at-bounce span{width:18px;height:18px;background:var(--loading-color,#3b82f6);border-radius:50%;animation:at-bounce 0.6s ease-in-out infinite}
.at-bounce span:nth-child(2){animation-delay:0.1s}
.at-bounce span:nth-child(3){animation-delay:0.2s}
@keyframes at-bounce{0%,100%{transform:translateY(0)}50%{transform:translateY(-20px)}}
    `.trim(),
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-progress{width:180px;height:6px;background:rgba(0,0,0,0.1);border-radius:3px;overflow:hidden}
.at-progress-bar{height:100%;background:var(--loading-color,#3b82f6);border-radius:3px;animation:at-progress 1.5s ease-in-out infinite}
@keyframes at-progress{0%{width:0;margin-left:0}50%{width:100%;margin-left:0}100%{width:0;margin-left:100%}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-morph{width:40px;height:40px;background:var(--loading-color,#3b82f6);animation:at-morph 1.2s ease-in-out infinite}
@keyframes at-morph{0%,100%{border-radius:0;transform:rotate(0deg)}50%{border-radius:50%;transform:rotate(180deg)}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-squares{position:relative;width:64px;height:64px}
.at-squares span{position:absolute;width:26px;height:26px;background:var(--loading-color,#3b82f6)}
...
@keyframes at-sq1{0%,100%{transform:translate(0,0)}25%{transform:translate(38px,0)}50%{transform:translate(38px,38px)}75%{transform:translate(0,38px)}}
@keyframes at-sq2{0%,100%{transform:translate(0,0)}25%{transform:translate(-38px,0)}50%{transform:translate(-38px,-38px)}75%{transform:translate(0,-38px)}}
    `.trim(),
...
@keyframes at-spin{to{transform:rotate(360deg)}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-heart{position:relative;width:40px;height:36px;animation:at-heartbeat 1s ease-in-out infinite}
.at-heart:before,.at-heart:after{content:'';position:absolute;top:0;width:23px;height:36px;background:var(--loading-color,#3b82f6);border-radius:23px 23px 0 0}
.at-heart:before{left:20px;transform:rotate(-45deg);transform-origin:0 100%}
...
@keyframes at-heartbeat{0%,100%{transform:scale(1)}15%{transform:scale(1.15)}30%{transform:scale(1)}45%{transform:scale(1.1)}60%{transform:scale(1)}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-wave{display:flex;gap:5px;align-items:end;height:52px}
.at-wave span{width:7px;background:var(--loading-color,#3b82f6);border-radius:3px}
...
@keyframes at-voice1{0%{height:14px}25%{height:40px}50%{height:20px}75%{height:48px}100%{height:14px}}
@keyframes at-voice2{0%{height:34px}25%{height:14px}50%{height:52px}75%{height:26px}100%{height:34px}}
@keyframes at-voice3{0%{height:20px}25%{height:48px}50%{height:14px}75%{height:34px}100%{height:20px}}
@keyframes at-voice4{0%{height:48px}25%{height:20px}50%{height:40px}75%{height:14px}100%{height:48px}}
@keyframes at-voice5{0%{height:26px}25%{height:52px}50%{height:34px}75%{height:20px}100%{height:26px}}
    `.trim(),
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-orbit{position:relative;width:64px;height:64px;animation:at-spin 2s linear infinite}
.at-orbit span{position:absolute;width:14px;height:14px;background:var(--loading-color,#3b82f6);border-radius:50%}
.at-orbit span:nth-child(1){top:0;left:50%;margin-left:-7px}
.at-orbit span:nth-child(2){top:50%;right:0;margin-top:-7px;opacity:0.8}
.at-orbit span:nth-child(3){bottom:0;left:50%;margin-left:-7px;opacity:0.6}
.at-orbit span:nth-child(4){top:50%;left:0;margin-top:-7px;opacity:0.4}
@keyframes at-spin{to{transform:rotate(360deg)}}
    `.trim(),
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-typing{display:flex;gap:7px;padding:18px 24px;background:rgba(0,0,0,0.08);border-radius:30px}
.at-typing span{width:14px;height:14px;background:var(--loading-color,#3b82f6);border-radius:50%;opacity:0.4;animation:at-typing-pulse 1.4s ease-in-out infinite}
...
@keyframes at-typing-pulse{0%,60%,100%{opacity:0.4;transform:scale(1)}30%{opacity:1;transform:scale(1.2)}}
  ...
  // Each step ~10%, with pause at end before instant reset
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-grid{display:grid;grid-template-columns:repeat(3,20px);gap:5px}
.at-grid span{width:20px;height:20px;background:var(--loading-color,#3b82f6);border-radius:3px}
...
@keyframes at-s4{0%{transform:translate(0,0)}10%,70%{transform:translate(25px,0)}80%,89%{transform:translate(25px,-25px)}90%,100%{transform:translate(0,0)}}
@keyframes at-s7{0%,10%{transform:translate(0,0)}20%,89%{transform:translate(0,-25px)}90%,100%{transform:translate(0,0)}}
@keyframes at-s8{0%,20%{transform:translate(0,0)}30%,89%{transform:translate(-25px,0)}90%,100%{transform:translate(0,0)}}
@keyframes at-s9{0%,30%{transform:translate(0,0)}40%,89%{transform:translate(-25px,0)}90%,100%{transform:translate(0,0)}}
@keyframes at-s6{0%,40%{transform:translate(0,0)}50%,89%{transform:translate(0,25px)}90%,100%{transform:translate(0,0)}}
@keyframes at-s3{0%,50%{transform:translate(0,0)}60%,89%{transform:translate(0,25px)}90%,100%{transform:translate(0,0)}}
@keyframes at-s2{0%,60%{transform:translate(0,0)}70%,89%{transform:translate(25px,0)}90%,100%{transform:translate(0,0)}}
    `.trim(),
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-grid-rotate{display:grid;grid-template-columns:repeat(3,18px);gap:6px;animation:at-grid-spin 3s linear infinite}
.at-grid-rotate span{width:18px;height:18px;background:var(--loading-color,#3b82f6);border-radius:3px}
...
@keyframes at-fade{0%,100%{opacity:0.3}50%{opacity:1}}
  ...
  },
  {
    ...
    css: `
.at-loader{display:flex;align-items:center;justify-content:center;height:100%;background:var(--loading-bg,transparent)}
.at-grid-fold{display:grid;grid-template-columns:repeat(3,20px);gap:5px;perspective:200px}
.at-grid-fold span{width:20px;height:20px;background:var(--loading-color,#3b82f6);border-radius:3px}
